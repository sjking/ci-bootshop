...
include_once(dirname(dirname(__DIR__)) . "/Template/Table_sorting.php");
...
class Generator_sorting extends Generator
{
	...
	public function generate()
	{
		...
		// table view
		$table = new Table_sorting($this->model->get_name(), 
