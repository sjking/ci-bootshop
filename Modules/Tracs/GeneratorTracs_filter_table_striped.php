...
include_once(dirname(dirname(__DIR__)) . "/Template/FilterTableFormInline.php");
...
class GeneratorTracs_filter_table_striped extends Generator
{
	...
	public function generate()
	{
		...
		// filter panel
		$form = new FilterTableFormInline($this->filter_model);
		...
		$form->set_container_params(array("class" => 'img-rounded', "id" => "filter-form-container"));
